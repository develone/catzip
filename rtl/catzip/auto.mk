...
## DO NOT EDIT THIS FILE!
##
## CmdLine:	autofpga autofpga -d -o . clockpll40.txt global.txt version.txt buserr.txt pic.txt pwrcount.txt gpio.txt sdramdev.txt bkram.txt hbconsole.txt zipbones.txt mem_sdram_only.txt
##
...
VFLIST := main.v  $(ZIPCPU) $(HBBUS) $(PPORT) $(SDRAM) $(GPIO) $(BKRAM) $(BUSPIC)
