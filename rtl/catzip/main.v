...
// DO NOT EDIT THIS FILE!
//
// CmdLine:	autofpga autofpga -o . global.txt bkram.txt buserr.txt clockpll40.txt pic.txt pwrcount.txt version.txt hbconsole.txt gpio.txt dlyarbiter.txt zipbones.txt sdramdev.txt mem_sdram_bkram.txt
//
...
// check
	...
	// from
	localparam	RESET_ADDRESS = 32'h00400000;
	//
...
`include "builddate.v"
 ...
 // 0x000004
	assign	      wb_dio_sel = ((wb_addr[21:18] &  4'hf) ==  4'h1); // 0x100000 - 0x100007
...
//x2	Was a master bus as well
	assign	       bkram_sel = ((wb_addr[21:18] &  4'hf) ==  4'h4); // 0x400000 - 0x401fff
