...
imagesc(im1);
colorbar;
title "red split from packed rgb catboard 0x8494c8 12/15/18"

figure;
imagesc(im2);
colorbar;
title "grn split from packed rgb catboard 0x8494c8 12/15/18"

figure;
imagesc(im3);
colorbar;
title "blu split from packed rgb catboard 0x8494c8 12/15/18"

figure;
imagesc(im4);
colorbar;
title "dwt red sub band catboard 0x8494c8 12/15/18"
